(function(obj) {
		...
		return {
			...
			getBlobURL : function(callback) {
				zipWriter.close(function(blob) {
					...
					callback(blobURL);
					sessionStorage.blobURL = blobURL;
					zipWriter = null;
				});
			},
	...
	(function() {
		...
		// var downURL = sessionStorage.blobURL;
			...
			if (!downloadButton.download) {
				if (typeof navigator.msSaveBlob == "function") {
					...
					// model.getBlobURL(function(blobURL) {
						console.log(sessionStorage.saveUrl,filenameInput.value,'---down');
						var clickEvent;
						clickEvent = document.createEvent("MouseEvent");
						clickEvent.initMouseEvent("click", true, true, window, 0, 0, 0, 0, 0, false, false, false, false, 0, null);
						downloadButton.href = sessionStorage.saveUrl;
